...
from utils.classification_list import get_classification_list
        ...
        try: # 통신문
            ...
            while repeat == 'y':                #다음 페이지가 있을 때만 실행
                ...
                for trade in result['res_list']: # 거래정보 가져오기
                    ...
                    # classification테이블에 저장된 print_content 와 그  print_content 의  type_id를 각각 리스트에 저장
                    c_p_c = []
                    c_t_id = []
                    ...
                    (user_id, trand_datetime, inout_type, print_content, tran_amt, type_id)
                    values
                    (%s, %s, %s, %s, %s, %s, %s)'''

                    param = (user_id, tran_datetime, inout_type, print_content, tran_amt, type_id)
